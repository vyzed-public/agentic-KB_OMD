...
2. ...containing YAML-based [automation workflow](https://github.com/vyzed-public/agentic-KB_OMD/blob/main/.github/workflows/sync-issues.yml) that: 
* **Archives & updates the web-based UX for creating/editing issues** 
  * ...into a per-project dir structure: **`./archive/issues`** 
  * ...that is easily downloadable (w/ a standard `git pull` ) onto local machines for additional processing
